...
from dataset.dataset_MyData import MyData
...
class myDataset(Dataset):
    def __init__(self, config, crop_size, grid_crop, mode="train", max_dim=None, aug=None):
        ...
        if mode == "train":
            ...
            if 'MyData' in training_set:
                self.dataset_list.append(MyData(crop_size, grid_crop, "dataset/data/MyData_train_list.txt", aug=aug))
            ...
            if 'MyData' in valid_set:
                self.dataset_list.append(MyData(crop_size, grid_crop, "dataset/data/MyData_val_list.txt", max_dim=max_dim, aug=aug))
